...
export default function NotificationsHub() {
  ...
  const getIconForType = (type: string) => {
    switch (type) {
      ...
      case "charity": return <Target className="w-5 h-5 text-green-400" />;
  ...
  const getGradientForType = (type: string) => {
    switch (type) {
      ...
      case "charity": return "from-green-900/20 to-green-900/5 border-green-500/20";
                ...
                <div className="relative flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <Badge className={alert.signal === "BUY" ? "bg-green-500/20 text-green-300" : "bg-blue-500/20 text-blue-300"}>
                        {alert.signal}
                      </Badge>
